 ...
 * global vars
 */
#define FP_DEV_1 "/sys/class/i2c-dev/i2c-0/device/0-0001/eeprom"
#define FP_DEV_2 "/sys/class/i2c-dev/i2c-0/device/0-0002/eeprom"
#define FP_DEV_3 "/sys/class/i2c-dev/i2c-0/device/0-0004/eeprom"
#define FP_DEV_4 "/sys/class/i2c-dev/i2c-0/device/0-0008/eeprom"

static int global_fd_1 = -1;
static int global_fd_2 = -1;
static int global_fd_3 = -1;
static int global_fd_4 = -1;
...
int fd_initial(int num)
{
	...
	*/
	...
	{
		printf("Open '%s' .. ", FP_DEV_4);
		fd = open(FP_DEV_4, O_RDWR );
	}
	else
	{
		printf("Open error.\n");
